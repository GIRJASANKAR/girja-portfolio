        ...
        <div className="max-w-7xl mx-auto">
          <div className={`space-y-6 ${isLoaded ? 'animate-fadeIn' : 'opacity-0'}`}>
            ...
            <div className="flex justify-center gap-2 mb-6">
              <div className="inline-block px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 text-sm text-purple-300">
                Frontend Developer SDE @ Wealthy
              </div>
              <div className="inline-block px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-sm text-cyan-300">
                3.9+ YOE
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              {['React.js', 'Next.js', 'Angular', 'TypeScript', 'Node.js', 'TailwindCSS'].map((tech) => (
                <div 
                  key={tech}
                  className="px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-white/20 text-sm font-medium text-gray-300 hover:text-white transition-colors"
                >
                  {tech}
                </div>
              ))}
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8 text-sm">
              <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10">
                ...
                <span className="text-gray-300">Currently @ <span className="text-white font-semibold">Wealthy</span></span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10">
                <span className="text-gray-400">Previously:</span>
                <span className="text-gray-300">Open Financial • AdPushup • Altruism Labs</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href="/resume"
                target="_blank"
                className="group relative px-8 py-3 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-purple-500/25 transform hover:scale-105 transition-all"
              >
              ...
              <button
                ...
                className="group px-8 py-3 border border-purple-500/50 rounded-lg font-semibold hover:bg-purple-500/10 transition-all"
              >
                <span className="flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-white/5 backdrop-blur border border-white/10">
                <h3 className="text-xl font-bold mb-4 text-purple-400">What I Bring to the Table</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start">
                    <span className="text-cyan-400 mr-3">✓</span>
                    <span className="text-gray-300">Deep expertise in modern JavaScript frameworks</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-cyan-400 mr-3">✓</span>
                    <span className="text-gray-300">Proven track record of delivering at scale</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-cyan-400 mr-3">✓</span>
                    <span className="text-gray-300">Strong focus on performance optimization</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-cyan-400 mr-3">✓</span>
                    <span className="text-gray-300">Experience with fintech compliance & security</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-cyan-400 mr-3">✓</span>
                    <span className="text-gray-300">Leadership & mentoring capabilities</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-cyan-400 mr-3">✓</span>
                    <span className="text-gray-300">Agile methodology practitioner</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-white/5 backdrop-blur border border-white/10">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">Companies Worked</span>
                    <span className="font-bold text-white">3</span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">Team Members Mentored</span>
              ...
              <div className="p-6 rounded-2xl bg-white/5 backdrop-blur border border-white/10">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Open Source', 'Fintech', 'UI/UX', 'Web3', 'AI/ML', 'Cloud Tech'].map((interest) => (
                    <span key={interest} className="px-3 py-1 rounded-full bg-purple-500/20 text-purple-300 text-sm">
                      {interest}
                    </span>
                  ))}
                </div>
      ...
      <section id="experience" className="min-h-screen py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-cyan-500 via-purple-500 to-pink-500 hidden md:block" />
            
            {EXPERIENCES.map((exp, index) => (
              <div key={index} className="relative mb-12 ml-0 md:ml-20">
                {/* Timeline Dot */}
                <div className="absolute -left-12 top-8 w-4 h-4 rounded-full bg-gradient-to-r from-cyan-500 to-purple-500 border-4 border-[#0a0a0a] hidden md:block" />
      ...
      <section id="skills" className="min-h-screen py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 p-6 rounded-2xl bg-white/5 backdrop-blur border border-white/10">
            ...
            <div className="flex flex-wrap gap-3">
              {['MongoDB', 'Node.js', 'Express', 'Jest', 'Bootstrap', 'Material-UI', 'Webpack', 'Babel', 'Git', 'Jira', 'Postman'].map((skill, i) => (
                <span key={i} className="px-3 py-1 text-sm rounded bg-white/10 text-gray-400">
                  {skill}
                </span>
              ))}
            </div>
          ...
          <div className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20">
            <h3 className="text-xl font-semibold mb-6 text-purple-400">Certifications & Achievements</h3>
            <div className="space-y-4">
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">Coding Ninjas • Issued Apr 2022</p>
                    <p className="text-xs text-gray-500 mt-2">Credential ID: 123309</p>
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">Coding Blocks • Issued May 2021</p>
                    <p className="text-xs text-gray-500 mt-2">Credential ID: CBOL-173173-834e</p>
                    <div className="flex items-center gap-1 mt-2 text-xs text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity">
                      <span>View Certificate</span>
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              ...
              <div className="p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all">
                <div className="flex items-start justify-between">
                  <div>
                    <h4 className="font-semibold text-white">JavaScript: The Hard Parts</h4>
                    <p className="text-sm text-gray-400 mt-1">Frontend Masters</p>
                  </div>
                  <div className="px-3 py-1 rounded-full bg-yellow-500/20 text-yellow-400 text-xs font-medium">
                    Advanced JS
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto w-full text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <a
              ...
              className="p-6 rounded-2xl bg-white/5 backdrop-blur border border-white/10 hover:bg-white/10 transition-all group"
            >
              ...
              <p className="font-medium group-hover:text-purple-400 transition-colors">tiwarigirjashankar36@gmail.com</p>
            </a>
            ...
            >
              ...
              <p className="font-medium group-hover:text-blue-400 transition-colors">Connect with me</p>
            </a>
            ...
            >
              ...
              <p className="font-medium group-hover:text-green-400 transition-colors">+91 9897747567</p>
            </a>
          </div>

          <button
            onClick={() => window.location.href = 'mailto:tiwarigirjashankar36@gmail.com'}
            className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg font-semibold text-lg hover:shadow-lg hover:shadow-purple-500/25 transform hover:scale-105 transition-all"
          >
